...
class CalcTest {
	...
	@Test
	@DisplayName("сложение больше 4 аргументов с переносом без разделител€")
	...
	@Test
	@DisplayName("ќшибка сложени€, аргумент пустой")
	...
	@Test
	@DisplayName("“ри аргумента с ошибкой текст в третьем аргументе")
...
//		assertThrows(NumberFormatException.class, ()->calc.sum("1,2,еуые"));
	...
	@Test
	@DisplayName("“ри аргумента с переполнением инт")
	...
	@Test
	@DisplayName("“ри аргумента с ошибкой разделител€")
...
//		assertThrows(NumberFormatException.class, ()->calc.sum("0,0ж3"));
	...
	@Test
	@DisplayName("“ри аргумента с негативным слагаемым")
